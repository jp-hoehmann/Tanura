...
(function() {
     ...
     * layout parameters manually in Js. As this happens after the resize, 
     * a second resize event may be triggered to give other Js code the ability 
     * to react to changes Tanura has made to the layout. In this case, this 
     * variable will be set to true, to tell Tanura, that the resize event was 
     * a fake resize event triggered by Tanura's own code and should be ignored.
     */
    ...
    var connect = () => {
        ...
        req.addEventListener('load', function() {
            ...
            var join = function() {
                ...
                room.addEventListener('stream-added', function(streamEvent) {
                    ...
                    if (localStream.getID() != streamEvent.stream.getID()) {
                        ...
                        // whiteboard.  This is wasteful as the new client will 
                        // get the state by each other client, but I don't know 
                        // a better way to do it.  The way forward will likely 
                        // be to have the server control the whiteboard.
            ...
            localStream.addEventListener('access-denied', function(event) {
                ...
                localStream.addEventListener(
                        'access-accepted', function(event) {
                            join();
                        });
                localStream.addEventListener('access-denied', function(event) {
